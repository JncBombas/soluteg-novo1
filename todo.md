...
- [x] Criar schema do banco de dados para Ordem de Serviço
- [x] Implementar procedures tRPC para CRUD
- [x] Criar página de cadastro de Ordem de Serviço
- [x] Criar página de listagem de Ordens
- [x] Integrar ao sistema de navegação do admin
- [ ] Testar fluxo completo (em progresso - erros de compilação TypeScript)
