...
// 1-3. Bombas Recalque, Dreno, Piscina (iguais)
...
// 4. Bomba Incêndio (máx 2 bombas + Pressão)
  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        { id: 'corrente_1', type: 'number', label: 'Corrente Bomba 1 (A)' },
        { id: 'corrente_2', type: 'number', label: 'Corrente Bomba 2 (A)', conditional: { field: 'quantidade_bombas', operator: '==', value: '2' } },
        { id: 'pressao', type: 'number', label: 'Pressão (bar)' }
      ]
    },
    {
      id: 'observations',
...
console.log('\n✅ Todos os 5 templates atualizados com estrutura correta!');
